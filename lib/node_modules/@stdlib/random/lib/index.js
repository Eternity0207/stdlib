...
*/
setReadOnly( ns, 'frechet', require( '@stdlib/random/frechet' ) );
...
* @readonly
* @type {Function}
* @see {@link module:@stdlib/random/hypergeometric}
*/
setReadOnly( ns, 'hypergeometric', require( '@stdlib/random/hypergeometric' ) );
...
*/
setReadOnly( ns, 't', require( '@stdlib/random/t' ) );
